    ...
    <table class="table-akun">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('siswa.edit', $siswa->id) }}" class="btn-edit" title="Edit">✏️</a>
                    <form action="{{ route('siswa.destroy', $siswa->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn-delete" title="Hapus" onclick="return confirm('Yakin ingin menghapus akun ini?')">🗑️</button>
                    </form>
                </td>
            </tr>
            @endforeach
            ...
            <tr>
                <td colspan="6" style="text-align:center; color: #ccc;">Belum ada data akun siswa.</td>
            </tr>
            @endif
        </tbody>
    </table>
