...
<head>
  ...
  <style>
    ...
    .table-responsive {
        border-radius: 12px;
        overflow: hidden;
        max-height: 300px; /* tinggi maksimum sebelum muncul scroll */
    ...
    <div class="stat-cards">
      <div class="stat-card animate_animated animate_fadeInLeft">
        ...
        <div>
          ...
          <div class="stat-desc">Total dana Diterima Beberapa Siswa</div>
        </div>
      </div>
...
<div class="stat-value animate_animated animate_fadeIn animate-delay-4">
    @if(!empty($semesterTerakhir))
        Semester {{ $semesterTerakhir }}
    @elseif(isset($semesterList) && $semesterList->isNotEmpty())
        Semester tersedia: {{ $semesterList->implode(', ') }}
    @else
